...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_split_3x6_5(
        ...
        CTL_T(KC_GRV),  KC_Z,  KC_X,     KC_C,     KC_V,              KC_B,                                  KC_N,    KC_M,    RCTL_T(KC_COMM),  KC_DOT,  RGUI_T(KC_SLSH),  C_S_T(KC_BSLS),
    ...
    [_MAC] = LAYOUT_split_3x6_5(
        ...
        KC_LSFT,        KC_A,  KC_S,     KC_D,     KC_F,              KC_G,                                  KC_H,    KC_J,    KC_K,             KC_L,    RSFT_T(KC_SCLN),  LSG_T(KC_QUOT),
        CTL_T(KC_GRV),  KC_Z,  KC_X,     KC_C,     KC_V,              KC_B,                                  KC_N,    KC_M,    RCTL_T(KC_COMM),  KC_DOT,  RGUI_T(KC_SLSH),  C_S_T(KC_BSLS),
                               KC_LEFT,  KC_RGHT,  LT(LOWER, KC_TAB), KC_BSPC, CMD_T(KC_DEL),  LT(RAISE, KC_RGUI),   KC_SPC,   KC_ENT,           KC_UP,   KC_DOWN
    ),
    ...
    [_LOWER] = LAYOUT_split_3x6_5(
        ...
        KC_CAPS,    KC_INS,     KC_LBRC,    KC_RBRC,    KC_LCBR,    KC_RCBR,                         KC_TRNS,  KC_1,    KC_2,     KC_3,     KC_TRNS,   KC_DOT,
                                KC_TRNS,    KC_MCTL,    KC_TRNS,    KC_TRNS,  KC_TRNS,     KC_BSPC,  KC_0,     KC_ENT,  KC_TRNS,  KC_TRNS
    ),

    [_RAISE] = LAYOUT_split_3x6_5(
        KC_TAB,         KC_PGUP,  KC_HOME,  KC_UP,    KC_END,   RGB_HUI,                        RGB_TOG,  TD(TD_F7),  TD(TD_F8),  TD(TD_F9),  KC_F10,  KC_TRNS,
        RCS_T(KC_LSFT), KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT,  RGB_HUD,                        KC_TRNS,  TD(TD_F4),  TD(TD_F5),  TD(TD_F6),  KC_F11,  KC_TRNS,
        KC_LCTL,        RGB_MOD,  RGB_SAD,  RGB_SAI,  RGB_VAD,  RGB_VAI,                        KC_TRNS,  TD(TD_F1),  TD(TD_F2),  TD(TD_F3),  KC_F12,  KC_TRNS,
                                  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  DF(MAC),    KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_TRNS
    ),
...
void y_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (ytap_state.state) {
        ...
        case TD_DOUBLE_SINGLE_TAP: tap_code(KC_GRV); register_code(KC_GRV); break;
        default: break;
    }
};
...
void y_reset(tap_dance_state_t *state, void *user_data) {
    switch (ytap_state.state) {
        ...
        case TD_DOUBLE_SINGLE_TAP: unregister_code(KC_GRV); break;
        default: break;
    }
